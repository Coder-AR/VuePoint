//Generated by Claude 4.6 & Gemini (Refactored for Student Photo Display)
    ...
    <body>
      ...
      <script>
        ...
        async function login() {
          ...
          // Render Student Card (UPDATED: Added dynamic portrait layout rendering)
...
app.post('/api/login', async (req, res) => {
  ...
  try {
    ...
    // Student Info (UPDATED: Extracting and parsing Base64 Photo blocks safely)
