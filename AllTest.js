//Generated by Claude 4.6 & Gemini (Refactored for Student Photo, Dynamic Report Card Matrix & Native PDF Streaming)
  ...
  res.send(`
    ...
    <body>
      ...
      <script>
        ...
        // NEW: Client-Side PDF Retrieval Streaming Architecture
        async function downloadPDF() {
          ...
          try {
            ...
            // Intercept data stream blob and compile a dynamic window target
...
// NEW: 4. API ENDPOINT: Fetch and Stream the Official Document Binary Blob
app.post('/api/report-card/download', async (req, res) => {
  ...
  try {
    ...
    // Query Synergy's native raw XML reporting engine method
    ...
    // Isolate target sheet structure
    ...
    // Synthesize binary buffer directly within RAM memory channels
    const pdfBuffer = Buffer.from(base64PDF, 'base64');

    // Attach headers configuring browser container for viewing
